...
Este projeto e todos os participantes dele são regidos pelo [Código de Conduta](CODE_OF_CONDUCT.md). Ao participar, espera-se que você siga este código. Por favor, reporte comportamentos inaceitáveis para [SEU_EMAIL_OU_CONTATO_PARA_DENUNCIAS]. *(Substitua o placeholder)*
